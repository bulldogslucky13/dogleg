...
export const COURSES: CourseSpec[] = [
  ...
  },
  {
    ...
    holes: holes([
      // strokeIndex = Heritage-tee scorecard HCP (bluegolf detailed card).
      [4, 414, 11, 'R', 'sand'],
      [5, 505, 13, 'S', 'water'],
      [4, 436, 9, 'L', 'sand'],
      [3, 200, 15, 'S', 'water'],
      ...
      [4, 439, 14, 'L', 'sand'],
      [3, 185, 16, 'S', 'water'],
      [4, 472, 2, 'L', 'ocean', 'Into the wind to the candy-striped lighthouse', undefined, 'lighthouse'],
    ]),
  },
  {
    slug: 'carnoustie',
  ...
  },
  {
    ...
    // Stroke indices are the club's published Blue card — 16 of the 18 shipped
    // wrong, and HCP feeds pressure() in the odds, so every one of those holes
    // was mis-weighted. Yardages auto-reconcile to the imported geometry.
    holes: holes([
      [4, 421, 5, 'S', 'sand'],
      [5, 548, 1, 'S', 'sand'],
      [3, 162, 17, 'S', 'sand'],
      ...
      [4, 365, 14, 'R', 'sand'],
      [4, 388, 8, 'S', 'sand'],
      [3, 139, 18, 'S', 'ocean', 'The little sister — a short poke across the cove'],
      [3, 231, 6, 'S', 'ocean', 'The great ocean carry — most of the way over the Pacific'],
      [4, 393, 10, 'L', 'ocean', 'Around the headland — the drive flirts with the cliffs'],
      [4, 346, 12, 'S', 'sand'],
    ]),
  },
  {
